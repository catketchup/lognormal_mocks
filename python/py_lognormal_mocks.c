...
static PyObject *__pyx_pw_18py_lognormal_mocks_1lognormal_mocks_stats(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("lognormal_mocks_stats (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Cl)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("lognormal_mocks_stats", 1, 3, 3, 1); __PYX_ERR(0, 21, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Ntheta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lognormal_mocks_stats", 1, 3, 3, 2); __PYX_ERR(0, 21, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "lognormal_mocks_stats") < 0)) __PYX_ERR(0, 21, __pyx_L3_error)
      }
    ...
    __pyx_v_rhobar = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_rhobar.memview)) __PYX_ERR(0, 21, __pyx_L3_error)
    __pyx_v_Cl = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_Cl.memview)) __PYX_ERR(0, 21, __pyx_L3_error)
    __pyx_v_Ntheta = values[2];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("lognormal_mocks_stats", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 21, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 * 
 */
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_rhobar, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyInt_FromSsize_t(__pyx_v_Nl); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  __pyx_t_8 = __Pyx_PyInt_As_int(__pyx_v_Nmaps); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 29, __pyx_L1_error)
  __pyx_t_9 = 0;
  __pyx_t_10 = -1;
  if (__pyx_t_9 < 0) {
  ...
  __pyx_t_10 = __Pyx_PyInt_As_int(__pyx_v_Ntheta); if (unlikely((__pyx_t_10 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 29, __pyx_L1_error)
 ...
 *     Nl = Cl.shape[2]
 */
  __pyx_tuple__21 = PyTuple_Pack(8, __pyx_n_s_rhobar, __pyx_n_s_Cl, __pyx_n_s_Ntheta, __pyx_n_s_Nmaps, __pyx_n_s_Nl, __pyx_n_s_gaussbar, __pyx_n_s_Clgauss, __pyx_n_s_xidelta); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 21, __pyx_L1_error)
 ...
 *     Nl = Cl.shape[2]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_18py_lognormal_mocks_1lognormal_mocks_stats, NULL, __pyx_n_s_py_lognormal_mocks); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_lognormal_mocks_stats, __pyx_t_1) < 0) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
