...
build/healpix_legendre_c.o: lognormal_mocks/src/healpix_legendre_c.c
	gcc -c lognormal_mocks/src/healpix_legendre_c.c -o build/healpix_legendre_c.o -I 	lognormal_mocks/include -I /home/ketchup/gsl -lm -fPIC -Wall -g

build/symmetric_legendre.o: lognormal_mocks/src/symmetric_legendre.c
	gcc -c lognormal_mocks/src/symmetric_legendre.c -o build/symmetric_legendre.o -I lognormal_mocks/include -I /home/ketchup/gsl -lm -fPIC -Wall -g

build/lognormal_mocks_stats.o: lognormal_mocks/src/lognormal_mocks_stats.c
	gcc -c lognormal_mocks/src/lognormal_mocks_stats.c -o build/lognormal_mocks_stats.o -I lognormal_mocks/include -I /home/ketchup/gsl -lm -fPIC -Wall -g
...
# 	gcc -c $(LOGNORMAL_MOCKS_STATS.C) -o $(LOGNORMAL_MOCKS_STATS.O) -I $(IDIR) -I /home/ketchup/gsl  -lm
